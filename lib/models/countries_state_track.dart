...
class CountriesStateTrack {
  ...
  CountriesStateTrack.fromJson(dynamic json) {
...
CountriesStateTrack copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => CountriesStateTrack(  updated: updated ?? _updated,
